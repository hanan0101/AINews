...
GENERAL_NEWS_EXA_ROWS = [
    ...
    },
    {
        ...
        "source_type": "general_news_layer",
        "query_mix": "general_layer",
        "query": '"HUMAIN" OR "هيومين" AI launches OR announces OR partnership',
        "use_news_category": True,
        "exa_num_results": 10,
    },
    {
        ...
        "source_type": "general_news_layer",
        "query_mix": "general_layer",
        "query": '"NEOM" artificial intelligence OR AI launches OR platform',
        "use_news_category": True,
        "exa_num_results": 10,
    },
    {
        ...
        "source_type": "general_news_layer",
        "query_mix": "general_layer",
        "query": '"Saudi" AI startup funding OR raises OR launches',
        "use_news_category": True,
        "exa_num_results": 10,
    },
    {
        ...
        "source_type": "general_news_layer",
        "query_mix": "general_layer",
        "query": '"Saudi" OR "KSA" AI university OR KAUST OR research initiative',
        "use_news_category": True,
        "exa_num_results": 10,
    },
    {
        ...
        "source_type": "general_news_layer",
        "query_mix": "general_layer",
        "query": "هيومين الذكاء الاصطناعي إطلاق شراكة",
        "use_news_category": True,
        "exa_num_results": 10,
    },
    {
        ...
        "source_type": "general_news_layer",
        "query_mix": "general_layer",
        "query": "شركة سعودية ذكاء اصطناعي تمويل استثمار",
        "use_news_category": True,
        "exa_num_results": 10,
    },
...
GENERAL_NEWS_SEARXNG_ROWS = [
    ...
    },
    {
        ...
        "source_type": "general_news_layer",
        "query_mix": "general_layer",
        "query": '"NEOM" "artificial intelligence"',
    },
    {
        "layer": "layer3",
        "bucket": "saudi_ai_news",
        "source_type": "general_news_layer",
        "query_mix": "general_layer",
        "query": '"Saudi" "AI startup" "funding"',
    },
    {
        "layer": "layer3",
        "bucket": "saudi_ai_news",
        "source_type": "general_news_layer",
        "query_mix": "general_layer",
        "query": '"هيومين" "الذكاء الاصطناعي" "شراكة"',
    },
]
