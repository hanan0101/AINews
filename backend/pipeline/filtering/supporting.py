...
from backend.config.settings import COURSE_INCLUDE_DOMAINS, memory_url_key, normalized_text, source_domain
from backend.pipeline.fetching.courses import course_url_is_direct
from backend.pipeline.filtering.memory import filter_candidates, item_story_key, save_memory
