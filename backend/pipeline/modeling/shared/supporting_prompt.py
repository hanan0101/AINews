...
from backend.pipeline.modeling.content.courses.prompt import build_courses_prompt
from backend.pipeline.modeling.content.films.prompt import build_films_prompt
